...
Planly is currently built and maintained by a single developer. External code contributions (pull requests) aren't being accepted yet — this keeps the codebase's direction and quality consistent while the project is still finding its shape.

That's a "not yet," not a permanent "no." As adoption grows, opening up to contributions is very much the plan.
