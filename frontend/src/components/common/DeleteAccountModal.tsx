    ...
    <Modal title="Delete account" onClose={onClose} width="max-w-sm">
      <div className="space-y-4">
        <div className="p-4 rounded-xl" style={{ background: '#ef444412', border: '1px solid #ef444433' }}>
          <p className="text-sm font-semibold mb-1" style={{ color: '#ef4444' }}>This action cannot be undone</p>
          <p className="text-sm" style={{ color: 'var(--text-2)' }}>
            Your account, profile, and all associated data will be permanently deleted.
            Other team members' tasks and messages you were part of will remain.
          </p>
        </div>
