      ...
      {open && (
        ...
        >
          <div
            ...
            style={{ width: '90vw', height: '90vh', maxWidth: 900, background: 'var(--surface)', border: '1px solid var(--border)' }}
          ...
          >
            <div className="flex items-center justify-between px-4 py-3 flex-shrink-0" style={{ borderBottom: '1px solid var(--border)' }}>
              ...
              <div className="flex items-center gap-2">
                <a href={url} download={name} className="text-xs px-3 py-1.5 rounded-lg" style={{ background: 'var(--surface-2)', color: 'var(--text-2)', border: '1px solid var(--border)' }}>
                  ↓ Download
                </a>
                <button
                  onClick={() => setOpen(false)}
