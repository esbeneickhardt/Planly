        ...
        <div className="space-y-8" style={{ fontSize: 15, lineHeight: 1.75 }}>
          <section>
            ...
            <p style={{ color: 'var(--text-2)' }}>
              By registering for or using Planly ("the Service"), you agree to be bound by these Terms of Service. If
          ...
          <section>
            ...
            <p style={{ color: 'var(--text-2)' }}>
              You retain ownership of all content you upload or create through the Service ("Your Content"). By
              submitting Your Content, you grant us a limited licence to store, display, and transmit it solely as
              necessary to provide the Service. We do not claim ownership of Your Content and will not share it with
              third parties except as described in the Privacy Policy.
            </p>
          </section>
          ...
          <section>
            ...
            <p style={{ color: 'var(--text-2)' }}>
              ...
              <button onClick={() => navigate('/privacy')} className="underline" style={{ color: 'var(--brand)' }}>
                Privacy Policy
              </button>{' '}
              and applicable data protection law (including GDPR where applicable). By using the Service, you
              acknowledge that your personal data will be processed as described therein.
            </p>
          </section>
          ...
          <section>
            ...
            <p style={{ color: 'var(--text-2)' }}>
              We reserve the right to modify, suspend, or discontinue the Service at any time with reasonable notice. We
              will endeavour to provide at least 7 days' notice for material changes that affect your use of the
              Service.
            </p>
          </section>
          ...
          <section>
            ...
            <p style={{ color: 'var(--text-2)' }}>
              ...
              limited to merchantability, fitness for a particular purpose, or non-infringement. We do not warrant that
          ...
          <section>
            ...
            <p style={{ color: 'var(--text-2)' }}>
              ...
              special, consequential, or punitive damages arising from your use of the Service, including loss of data,
          ...
          <section>
            ...
            <p style={{ color: 'var(--text-2)' }}>
              These Terms are governed by and construed in accordance with the laws of Denmark. Any disputes shall be
              subject to the exclusive jurisdiction of the courts of Copenhagen, Denmark.
            </p>
          </section>
